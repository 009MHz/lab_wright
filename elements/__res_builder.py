...
class EduHistory:
    ...
    name_lists = "//div[@id='educationNameList']//div[contains(@class, 'holder-inner')]"
    name_list_item = "(//div[@id='educationNameItem'])"
    name_list_add = "//div[@id='educationNameList']/div[contains(@class, 'addMenu')]"
