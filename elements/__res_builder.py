...
class DataDiri:
    ...
    class Filled:
        ...
        name = "//div[@id='dataProfInfoSelfDataName']"
        first_name = "#dataProfInfoSelfDataFirstName"
        last_name = "#dataProfInfoSelfDataLastName"
        email = "#dataProfInfoSelfDataEmail"
        phone = "#dataProfInfoSelfDataPhone"
        province = "#dataProfInfoSelfDataProvince"
        city = "#dataProfInfoSelfDataCity"
